...
--
-- Host: localhost    Database: testzad1
-- ------------------------------------------------------
...
INSERT INTO `anketa` VALUES ('анна',68,'Алекс','Петров','Евгнеьевич','Моб +375263567'),('Светлана',69,'','','',''),('',70,'','','',''),('',71,'','','','');
...
CREATE TABLE `mastera` (
  ...
  `wozr` int(11) DEFAULT NULL,
  `wes` int(11) DEFAULT NULL,
  `rost` int(11) DEFAULT NULL,
  `grud` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `mastera` VALUES (1,'аннна','',23,56,170,56),(2,'валя','',22,54,180,65),(3,'настя','',35,57,167,54);
...
--
-- Table structure for table `sozseti`
--

DROP TABLE IF EXISTS `sozseti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sozseti` (
  `id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `sozseti`
--

LOCK TABLES `sozseti` WRITE;
/*!40000 ALTER TABLE `sozseti` DISABLE KEYS */;
INSERT INTO `sozseti` VALUES (1,'W kontakte','https://vk.com/club117119140',NULL),(2,'Whatsap','https://www.whatsapp.com/',NULL),(3,'Instagram','https://www.instagram.com/spirin.costia/',NULL);
/*!40000 ALTER TABLE `sozseti` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `towar` VALUES (1,7,'анна','',10,'','','12.jpg','2019-12-20','34',54,180,56),(2,7,'Жанна','',56,'','','12bg.jpg','2019-12-31',NULL,NULL,NULL,NULL),(4,7,'Светлана','',70,'','','1.jpg',NULL,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `zagol1`
--

DROP TABLE IF EXISTS `zagol1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zagol1` (
  `naim` longtext CHARACTER SET utf8,
  `id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `zagol1`
--

LOCK TABLES `zagol1` WRITE;
/*!40000 ALTER TABLE `zagol1` DISABLE KEYS */;
INSERT INTO `zagol1` VALUES ('РЕЛАКС САЛОН ДЛЯ МУЖЧИН,ЖЕНЩИН И ПАР',0);
/*!40000 ALTER TABLE `zagol1` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-03-25 12:11:32
